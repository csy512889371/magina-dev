 ...
 * 多数据源配置
 */
public class ThreadLocalDynamicDataSource extends AbstractRoutingDataSource implements InitializingBean {

	public static final String KEY_DEFAULT_DATASOURCE = "default";
