...
import com.rjsoft.magina.cpn.tcc.hmily.common.config.HmilyDbConfig;
...
import com.rjsoft.magina.cpn.tcc.hmily.core.helper.SqlHelper;
import com.rjsoft.magina.cpn.tcc.hmily.core.spi.HmilyCoordinatorRepository;
import com.rjsoft.magina.cpn.tcc.hmily.common.utils.*;
...
public class JdbcCoordinatorRepository implements HmilyCoordinatorRepository {
    ...
    private Object convertDataTypeToDB(final Object params) {
        ...
        if (CommonConstant.DB_POSTGRESQL.equals(currentDBType) && params instanceof Date) {
