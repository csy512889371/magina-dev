package com.rjsoft.component.codegenerator.utils;
 ...
 * Autor: Created by qunli on 2016/12/1.
 */
public class FtUtil {
    /**
     * 获取模板
     ...
     * Description:  <br/>
     */
    public void generateFile(String templatesDir, String templateName, Object root, String outDir, String outFileName) {
        FileWriter out = null;
        try {
