...
public class RepositoryFtlDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (JpaEntity entity : tables) {
            ...
            {
                String fileName =
                        StringUtils.toUpperCaseFirstOne(camel) + "Repository.java";
                String outDir = path + "com/rjsoft/jycj/process/repository/jycj/";
                ftUtil.generateFile("/ftl/temp", "JpaRepository.java.temp.ftl", entity, outDir, fileName);
            }
        }
    }
}
