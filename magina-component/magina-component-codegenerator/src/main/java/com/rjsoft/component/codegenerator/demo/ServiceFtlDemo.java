...
public class ServiceFtlDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (JpaEntity entity : tables) {
            ...
            {
                String fileName =
                        StringUtils.toUpperCaseFirstOne(camel) + "Service.java";
                String outDir = path + "com/rjsoft/jycj/process/biz/service/jycj/";
                ftUtil.generateFile("/ftl/temp", "JpaService.java.temp.ftl", entity, outDir, fileName);
            }
        }
    }
}
